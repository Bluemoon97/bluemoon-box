...
function setupButtons() {
    ...
    const btnRegisteredJanCancel = document.getElementById("btnRegisteredJanCancel");
    ...
    if (btnRegisteredJanCancel) {

        btnRegisteredJanCancel.addEventListener(
            ...
            productCard.innerHTML = `
                ...
                <div class="product-buttons">
                    ...
                    <button
                        ...
                        onclick="openPriceRecord('${product.id}')">
