...
function displayProducts() {
    ...
    for (const product of products) {
        ...
        <div class="product-card">
            ...
            <p><span class="product-label">カテゴリー</span><span class="product-value">${getCategoryName(product.categoryId)}</span></p>
...
function displayDeletedProducts() {
    ...
    for (const product of products) {
        ...
        <div class="product-card">
            ...
            <p><span class="product-label">カテゴリー</span><span class="product-value">${product.categoryId}</span></p>

            <p><span class="product-label">内容量</span><span class="product-value">${product.volume}${product.unit}</span></p>

            <p><span class="product-label">価格</span><span class="product-value">¥${product.price || "-"}</span></p>

            <p><span class="product-label">店舗</span><span class="product-value">${product.storeId || "-"}</span></p>
