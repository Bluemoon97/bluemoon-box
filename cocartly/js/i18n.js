...
const COCARTLY_TRANSLATIONS = {
    ...
    en: {
        ...
        "product.message.registeredSelected":
            "The registered product \"{name}\" has been selected.",
    ...
    "zh-TW": {
        ...
        "product.help.feature3":
            "記錄購買通路與價格後，可在「購買紀錄 · 價格比較」查看過去的價格。",
