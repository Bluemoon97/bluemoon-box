...
const COCARTLY_TRANSLATIONS = {
    ...
    "zh-CN": {
        ...
        */
        ...
        "shopping.finish.completed":
            "本次购物已完成。\n\n已保存到购买记录：{historyCount} 件\n新添加商品：{registeredCount} 件",
    ...
    "zh-TW": {
        ...
        */
        ...
        "shopping.finish.completed":
            "購物完成。\n\n已儲存至購買紀錄：{historyCount} 項\n新增加入商品：{registeredCount} 項",
    ...
    fr: {
        ...
        */
        ...
        "shopping.finish.completed":
            "Achats terminés.\n\nAjoutés à l’historique : {historyCount}\nNouveaux produits enregistrés : {registeredCount}",
